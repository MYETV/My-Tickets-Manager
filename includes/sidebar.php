...
<style>
/* Regolazioni larghezza e gestione testo su più righe */
#sidebar-wrapper {
...
#sidebar-wrapper .list-group-item {
    ...
    line-height: 1.3;               /* Spaziatura ottica per il testo multilinea */
    padding-top: 0.6rem;
...
#sidebar-wrapper .list-group-item i {
    ...
    width: 20px;                    /* Larghezza fissa per perfetto allineamento verticale */
    text-align: center;
}
</style>
...
<aside id="sidebar-wrapper" class="border-end border-secondary">
    <div class="list-group list-group-flush py-3">
        ...
        <a href="/index.php" class="list-group-item list-group-item-action d-flex align-items-center bg-transparent border-0" title="<?php echo __('home', 'Home'); ?>">
            <i class="fa-solid fa-house me-2 text-primary"></i>
            <span class="link-text"><?php echo __('home', 'Home'); ?></span>
        </a>
        <a href="/submit.php" class="list-group-item list-group-item-action d-flex align-items-center bg-transparent border-0" title="<?php echo __('submit_ticket', 'Submit Ticket'); ?>">
            <i class="fa-solid fa-plus-circle me-2 text-success"></i>
            <span class="link-text"><?php echo __('submit_ticket', 'Submit Ticket'); ?></span>
        </a>
        <a href="/track.php" class="list-group-item list-group-item-action d-flex align-items-center bg-transparent border-0" title="<?php echo __('track_ticket', 'Track Ticket'); ?>">
            <i class="fa-solid fa-magnifying-glass me-2 text-info"></i>
            <span class="link-text"><?php echo __('track_ticket', 'Track Ticket'); ?></span>
        </a>

        <?php if ($isLoggedIn): ?>
            <a href="/profile.php" class="list-group-item list-group-item-action d-flex align-items-center bg-transparent border-0" title="<?php echo __('account_settings', 'Account Settings'); ?>">
        ...
        <?php if ($isStaff): ?>
            ...
            <a href="/admin/dashboard.php" class="list-group-item list-group-item-action d-flex align-items-center bg-transparent border-0" title="<?php echo __('dashboard', 'Dashboard'); ?>">
                <i class="fa-solid fa-chart-line me-2 text-primary"></i>
                <span class="link-text"><?php echo __('dashboard', 'Dashboard'); ?></span>
            </a>
            <a href="/admin/tickets.php" class="list-group-item list-group-item-action d-flex align-items-center bg-transparent border-0" title="<?php echo __('tickets', 'Tickets'); ?>">
            ...
            <?php if ($isAgency): ?>
                ...
                <a href="/admin/agencies.php" class="list-group-item list-group-item-action d-flex align-items-center bg-transparent border-0" title="<?php echo __('agencies_and_agents', 'Agencies & Agents'); ?>">
            ...
            <?php if ($isAdmin): ?>
                ...
                <a href="/admin/users.php" class="list-group-item list-group-item-action d-flex align-items-center bg-transparent border-0" title="<?php echo __('all_users', 'All Users'); ?>">
                    <i class="fa-solid fa-users-gear me-2 text-danger"></i>
                    <span class="link-text"><?php echo __('all_users', 'All Users'); ?></span>
                </a>
                <a href="/admin/categories.php" class="list-group-item list-group-item-action d-flex align-items-center bg-transparent border-0" title="<?php echo __('categories', 'Categories'); ?>">
                    <i class="fa-solid fa-folder me-2 text-warning"></i>
                    <span class="link-text"><?php echo __('categories', 'Categories'); ?></span>
                </a>
                <a href="/admin/settings.php" class="list-group-item list-group-item-action d-flex align-items-center bg-transparent border-0" title="<?php echo __('settings', 'Settings'); ?>">
                    <i class="fa-solid fa-sliders me-2 text-secondary"></i>
                    <span class="link-text"><?php echo __('settings', 'Settings'); ?></span>
                </a>
                <a href="/admin/rate_limits.php" class="list-group-item list-group-item-action d-flex align-items-center bg-transparent border-0" title="<?php echo __('rate_limits', 'Rate Limits'); ?>">
                    <i class="fa-solid fa-gauge-high me-2 text-success"></i>
                    <span class="link-text"><?php echo __('rate_limits', 'Rate Limits'); ?></span>
                </a>
                <a href="/admin/translations.php" class="list-group-item list-group-item-action d-flex align-items-center bg-transparent border-0" title="<?php echo __('translations', 'Translations'); ?>">
                    <i class="fa-solid fa-language me-2 text-info"></i>
                    <span class="link-text"><?php echo __('translations', 'Translations'); ?></span>
                </a>
                <a href="/admin/update.php" class="list-group-item list-group-item-action d-flex align-items-center bg-transparent border-0" title="<?php echo __('system_updates', 'System Updates'); ?>">
